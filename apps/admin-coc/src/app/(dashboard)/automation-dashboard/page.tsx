...
import { AutomationSignalHealthPanel } from "@/components/automation/automation-signal-health-panel";
...
import { presentAutomationSignalHealth } from "@/lib/automation/present-signal-health";
    ...
    <div className="space-y-5">
      ...
      <div className="grid gap-5 lg:grid-cols-2">
        <SectionPanel title="Signal health">
          {signal ? (
            <AutomationSignalHealthPanel signal={presentAutomationSignalHealth(signal)} />
          ) : (
