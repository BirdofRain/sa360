  ...
  return {
    ...
    recentIntake: payload.recentIntake.map(
      (row): RecentLeadIntakeRow => ({
        ...
        inventoryTrackingOutcome: row.inventoryTrackingOutcome,
        inventoryTrackingOutcomeCode: row.inventoryTrackingOutcomeCode,
        inventoryTrackingLabel: row.inventoryTrackingLabel,
        inventoryTrackingDetail: row.inventoryTrackingDetail,
        canonicalInventoryItemId: row.canonicalInventoryItemId,
        canonicalInventoryOnOtherEvent: row.canonicalInventoryOnOtherEvent,
