 ...
 *
 * Must stay byte-for-byte equivalent to the SQL CASE used by the supply
 * snapshot rebuild (inventory-derived).
 *
 ...
 * Mirrors deployed live SQL that read enrichmentMetadataJson / sourceProvider / sourceSystem.
 */
