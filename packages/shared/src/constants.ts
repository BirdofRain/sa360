...
export const LEAD_INVENTORY_REVIEW_QUARANTINE_CONFIRMATION =
  "QUARANTINE SELECTED INVENTORY" as const;
export const LEAD_INVENTORY_REVIEW_REJECT_CONFIRMATION =
